...
const EngineeringSection: React.FC = () => {
  return (
    <section className="relative w-full py-32 lg:py-48 bg-white border-t border-gray-200 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="flex flex-col items-start pr-0 lg:pr-12">
            <div className="inline-block px-3 py-1 mb-6 border border-gray-300 text-xs font-bold tracking-widest uppercase text-gray-500 bg-white/50 backdrop-blur-sm">
              Mission Statement
            </div>
            ...
            <div className="w-16 h-1 bg-blue-600 mt-10" />
          </div>

          {/* Right side: 3D Raymarching Shader */}
          <div className="w-full lg:pt-32 h-[600px] flex flex-col justify-end">
            <div className="relative w-full h-full border border-gray-900 bg-black overflow-hidden shadow-[20px_20px_0px_rgba(0,0,0,0.05)]">
